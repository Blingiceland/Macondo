...
function NavEN() {
    ...
    const navLinkClass = "text-[15px] uppercase tracking-[0.16em] font-medium text-[#f5f2ee]/[0.78] hover:text-[#c6a46c] transition-colors relative group";
                ...
                >
                    ...
                    <div className="flex items-center gap-7">
                        <button
                            ...
                            style={{ fontFamily: "var(--font-cinzel), serif", padding: "14px 34px" }}
                        >
                            Book Table
                        </button>
